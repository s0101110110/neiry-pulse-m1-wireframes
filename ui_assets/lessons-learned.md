...
## SCOPE — отложенные задачи (приоритизированы PM 17.06)

### 1. Глобальная замена шрифтов (приоритет: первый после команды PM)
- **Что:** Onest / Space Grotesk / Geist Mono → **Golos Text + JetBrains Mono** (утверждены Никитой)
- **Scope:** все 25 HTML wireframes в `docs_web/wireframes/m3/`
- **Mapping:**
  - Onest (hero) → Golos Text 600/700
  - Space Grotesk (body) → Golos Text 400/500
  - Geist Mono (labels/numbers) → JetBrains Mono
- **Связано:** DESIGN-preview.html (другое окно с агентом)
- **Дата постановки:** 2026-06-17 (PM)

### 2. Rebrand «Pulse» + DESIGN-preview update — обрабатывается отдельно
- PM работает в другом окне с агентом
